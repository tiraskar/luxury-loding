      ...
      <div className="text-[#333333] font-onest tracking-tight flex flex-col justify-start space-y-[52px] md:space-y-[68px] lg:space-y-[76px] md:pt-7">
        <div className="space-y-5 items-center">
          ...
          {/* <div className="flex justify-between items-center  h-[58px]">
            <Link to='https://luxurylodgingpm.com/' target="_blank" className="hidden xxs:flex items-center font-semibold bg-buttonPrimary text-white px-4 py-1.5 xs:h-[41px] w-fit rounded-lg cursor-pointer">Partner with Us</Link>
            <Link to='https://luxurylodgingpm.com/' target="_blank" className=" text-white bg-buttonPrimary font-semibold xxs:hidden py-1 px-2 rounded-md">Partner with Us</Link>
          </div> */}
        </div>
