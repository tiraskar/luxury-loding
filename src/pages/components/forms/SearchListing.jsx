  ...
  return (
    <Wrapper>
      <div className="space-y-6">
        ...
        <form onSubmit={() => console.log('listing form submitted')} className=" grid grid-cols-2  sm:flex flex-wrap justify-between items-center gap-3 bg-[#F9F9F9] p-4 rounded-2xl font-onest tracking-[-1%] ">
          ...
          <div className="flex flex-row gap-2 w-full sm:w-auto">
            <button type="button" onClick={() => setIsFilterOpen(true)} className="text-black bg-white border-[0.6px] border-[#D7DBE8] rounded-xl px-4 py-3 sm:py-4 h-fit flex items-center justify-center text-[13px] font-medium w-[100px]">
